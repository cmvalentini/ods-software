...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div   class="mx-auto" style="width:300px">
            <h2>
                <asp:Label ID="lblgestorfamilias" runat="server" Text="Gestor de Familias"></asp:Label>
        ...
        <div  class="container">
            <div  class="row">
                <div   class="col align-self-end">              
                    ...
                    <asp:Button ID="btnback" runat="server" Text="Back" CssClass="btn btn-dark form-control-sm" OnClick="btnback_Click" />
                    </div>
                ...
                <asp:GridView runat="server" ID="dvgFamilys" CssClass="table table-borderless table-hover">
                    <Columns>
                        <asp:TemplateField HeaderText="Opciones del Administrador">
                            <ItemTemplate>
                                <asp:Button Text="Update" ID="btnUpdateFamily" CssClass="btn form-control-sm btn-warning" runat="server" OnClick="btnUpdateFamily_Click" />
                              <asp:Button Text="Delete" ID="btnDeleteFamily" CssClass="btn form-control-sm btn-danger" runat="server" OnClick="btnDeleteFamily_Click" />
                            </ItemTemplate>
