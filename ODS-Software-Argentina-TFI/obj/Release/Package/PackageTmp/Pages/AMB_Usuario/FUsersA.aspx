...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="mx-auto" style="width:250px" >
       ...
       <br />
        ...
        <div class="mb-3">
            <label class="form-label" id="lblnombre" text="Nombre"></label>
          ...
          <div class="mb-3">
            <label class="form-label" id="lblapellido" text="Apellido"> </label>
        ...
        <div class="mb-3">
            ...
            <asp:TextBox runat="server" CssClass="form-control" ID="txtemail"></asp:TextBox>
                          <asp:RegularExpressionValidator ID="remail" Display="Dynamic" ValidationGroup="VGuardar" runat="server" CssClass="validadores" ControlToValidate="txtemail"
        ...
        <asp:Button Text="Actualizar" ID="BtnUpdate" ValidationGroup="VGuardar" CssClass="btn form-control-sm btn-danger" Visible="false"  runat="server" OnClick="BtnUpdate_Click"/>  
