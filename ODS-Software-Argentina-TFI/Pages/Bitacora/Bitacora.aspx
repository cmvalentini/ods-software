<%@ Page Title="" Language="C#" MasterPageFile="~/Menu_operaciones.Master" AutoEventWireup="true" CodeBehind="
    .aspx.cs" Inherits="ODS_Software_Argentina_TFI.Pages.Bitacora.Bitacora" %>
...
<asp:Content ID="bodycontent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="mx-auto" style="width: 300px">
        <h2 class="h2 align-content-center">
            <asp:Label ID="lblbitacoratitulo" runat="server" Text="Bitácora"></asp:Label>
     ...
     <div class="container">
        <div class="row">
            <div class="col align-self-end">
                ...
                <asp:Button ID="btnexportlog" runat="server" CssClass="btn btn-info form-control-sm" Text="Exportar XML" Visible="false" OnClick="btnExport_Click" />
